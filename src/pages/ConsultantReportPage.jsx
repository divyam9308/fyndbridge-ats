...
export default function ConsultantReportPage() {
  ...
  const selectedOption = useMemo(
    () => options.find((option) => option.key === appliedFilters?.consultantUserId),
    [appliedFilters?.consultantUserId, options]
  )
    ...
    <div className="consultant-report-page">
          ...
          <label className="report-control report-consultant-control">
            ...
            <div>
              ...
              <datalist id="report-consultants">
                {options.map((option) => <option key={option.key} value={option.inputLabel}>{option.email}</option>)}
              </datalist>
            </div>
          </label>
      ...
      {optionsError && !report ? (
        ...
        <>
          ...
          {activeTab === 'mandates' && <MandatesReport report={report} openModal={setModal} />}
          {activeTab === 'candidates' && <CandidatesReport report={report} />}
          {activeTab === 'attendance' && <OutcomesReport report={report} />}
