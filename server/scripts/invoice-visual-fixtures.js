...
const CASES = Object.freeze([
  ...
  },
  {
    ...
    taxableAmount: '558720',
    invoiceNumber: 'FCAPL/26-27/001',
    referenceFile: 'FCAPL CGST SGST.pdf',
    a4Profile: profile({
      sourceY: [21.72, 66.98, 85.10, 237.65, 257.81, 410.09, 424.75, 439.39, 454.03, 467.95, 481.87, 495.79, 509.71, 523.63, 537.55, 610.42, 698.26],
      targetX: [21.13, 67.00, 255.32, 328.64, 410.22, 466.40, 568.43],
      targetSummaryX: [181.05],
      targetY: [21.13, 65.15, 82.77, 231.16, 250.76, 444.25, 458.51, 472.75, 486.99, 500.53, 514.07, 527.61, 541.15, 554.69, 568.23, 639.10, 750.71],
      ruleThickness: [0.82],
      bodySize: 8.64,
      metaSize: 9.10,
      titleSize: 14.47
